<template>
  <article class="article-module d-flex br-4 mb-30 fade-in">
    ...
    <div class="align-self-top pl-20">
        <div class="votes text-center">
          ...
          <b-button class="vote btn btn-transparent bg-brand icon-wrap" @click="upVote(article.id, article.vote_count)">
            <svg v-if="article.statusType.id == 55" id="ten-x" class="push-button" width="34" height="42" viewBox="0 0 22 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-else="article.statusType.id == 50"  class="active push-button" width="12" height="42" viewBox="0 0 9 28" fill="none" xmlns="http://www.w3.org/2000/svg">
