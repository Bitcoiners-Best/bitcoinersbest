<template>
  <section class="signup mt-50 text-center fade-in">
    ...
    <div class="mb-50 text-center auth-cta">
      <a class="btn btn-rect-xl twitter mt-50 c-white push-button" href="/site/auth?authclient=twitter"><svg class="mr-15" width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
