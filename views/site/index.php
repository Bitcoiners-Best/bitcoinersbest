...
<div class="module-container">
  ...
  <div class="book-module d-flex br-4 mb-30">
      ...
      <div class="flex-grow-1 align-self-center">
          <h6 class="text-uppercase c-white-offset medium mb-10">SAIFEDEAN AMMOUS</h6>
  ...
  <div class="podcast-module d-flex br-4 mb-30">
      ...
      <div class="flex-grow-1 align-self-center">
          <h6 class="text-uppercase c-white-offset medium mb-10">MARY BENT</h6>
  ...
  <div class="thread-module d-flex br-4 mb-30">
      ...
      <div class="flex-grow-1 align-self-center">
          <h6 class="c-white"><strong class="c-white-offset">username</strong> @username · <span class="c-white-offset time">17m</span></h6>
          <h5 class="c-white regular">MacBook Air Refresh With Spec Bumps Said To Be Coming Tomorrow</h5>
          <h5 class="c-white-offset regular"><a class="link" href="">Linked element</a> by <a class="link" href="">@username</a></h5>
      </div>
      <div class="align-self-top pl-20">
          <div class="votes text-center">
              <h6 class="medium mb-5 c-white">535</h6>
