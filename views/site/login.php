...
<section class="login mt-50 text-center fade-in">
  ...
  <div class="section-header pt-50 text-center">
      <h2 class="mb-0 c-white">Welcome back</h2>
  </div>
  <div class="text-center mb-50">
    <a class="btn btn-rect-xl twitter c-white mt-50 push-button" href="<?=\yii\helpers\Url::to(['site/auth','authclient'=>'twitter']);?>"><svg class="mr-15" width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- <button class="btn btn-rect-xl bg-brand c-black mt-50 push-button"><svg class="mr-15" width="10" height="17" viewBox="0 0 10 17" fill="none" xmlns="http://www.w3.org/2000/svg">
