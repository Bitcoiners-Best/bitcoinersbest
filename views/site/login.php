...
<section class="login mt-50 text-center">
  ...
  <div class="text-center mb-50">
    <button class="btn btn-rect-xl twitter c-white mt-50 push-button"><svg class="mr-15" width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
