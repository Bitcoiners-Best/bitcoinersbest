...
<section class="signup mt-50 text-center">
  ...
  <p class="mt-50 mb-0 c-white">Join the community of Bitcoin creators. All sats spent to upvote content are donated to an open source project!</p>
  <div class="mb-50 text-center auth-cta">
    <button class="btn btn-rect-xl twitter mt-50 c-white"><svg class="mr-15" width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <button class="btn btn-rect-xl mt-50 bg-brand c-black"><svg class="mr-15" width="10" height="17" viewBox="0 0 10 17" fill="none" xmlns="http://www.w3.org/2000/svg">
