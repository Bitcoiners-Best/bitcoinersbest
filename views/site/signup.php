...
<section class="signup mt-50 text-center fade-in">

  <svg class="mobile-hide" width="79.28" height="92" viewBox="0 0 35 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <p class="mt-50 mb-0 c-gray-1">Join the community of Bitcoin creators. All sats spent to upvote content are donated to an open source project!</p>
  <div class="mb-50 text-center auth-cta">
    <a class="btn btn-rect-xl twitter mt-50 c-white push-button" href="<?=\yii\helpers\Url::to(['site/auth','authclient'=>'twitter']);?>"><svg class="mr-15" width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    </svg>Join with Twitter</a>
    <button class="btn btn-rect-xl mt-50 bg-brand c-black push-button"><svg class="mr-15" width="10" height="17" viewBox="0 0 10 17" fill="none" xmlns="http://www.w3.org/2000/svg">
