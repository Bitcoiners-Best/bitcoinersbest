...
<section class="signup mt-50 text-center">
  ...
  <div class="mb-50 text-center auth-cta">
    <button class="btn btn-rect-xl twitter mt-50 c-white push-button"><svg class="mr-15" width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
