...
<section class="signup mt-50 text-center">
  ...
  <div class="text-center mt-50 mb-50 auth-cta">
    <a class="btn btn-rect-xl twitter c-white" href="<?=\yii\helpers\Url::to(['site/auth','authclient'=>'twitter']);?>"><svg class="mr-15" width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
