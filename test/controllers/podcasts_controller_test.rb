...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { created_by: @podcast.created_by, description: @podcast.description, rss: @podcast.rss, title: @podcast.title, url: @podcast.url } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { created_by: @podcast.created_by, description: @podcast.description, rss: @podcast.rss, title: @podcast.title, url: @podcast.url } }
